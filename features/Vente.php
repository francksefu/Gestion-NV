...
require_once __DIR__ . '/connect.php';
  ...
  class Produit {
    ...
    public function insert ($Nom, $ImageLink , $PrixAchat, $PrixVente, $PrixVmin, $QuantiteStock, $QuantiteStockMin, $DescriptionP)
    {
      global $pdo;
	  $sql = 'INSERT INTO Produit(Nom, ImageLink , PrixAchat, PrixVente, PrixVmin, QuantiteStock, QuantiteStockMin, DescriptionP) VALUES(?,?,?,?,?,?,?,?)';
    ...
    public function update ($Nom, $ImageLink , $PrixAchat, $PrixVente, $PrixVmin, $QuantiteStock, $QuantiteStockMin, $DescriptionP, $idProduit)
    {
		global $pdo;
		$produit = [
			$Nom, $ImageLink , $PrixAchat, $PrixVente, $PrixVmin, $QuantiteStock, $QuantiteStockMin, $DescriptionP, $idProduit
		];
		
		$sql = 'UPDATE Produit
				SET Nom = ?, ImageLink = ? , PrixAchat = ?, PrixVente = ?, PrixVmin = ?, QuantiteStock = ?, QuantiteStockMin = ?, DescriptionP = ?
				WHERE idProduit = ?';
